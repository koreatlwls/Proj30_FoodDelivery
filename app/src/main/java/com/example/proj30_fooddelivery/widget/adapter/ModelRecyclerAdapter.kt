...
import com.example.proj30_fooddelivery.FoodDeliveryApplication
...
class ModelRecyclerAdapter<M : Model, VM: BaseViewModel>(
    ...
    private val resourcesProvider: ResourcesProvider = DefaultResourcesProvider(FoodDeliveryApplication.appContext!!),
